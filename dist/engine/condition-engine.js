function getValueFromInput(input, field) {
...
export function evaluateConditions(conditions, input) {
    ...
    if (Array.isArray(conditions)) {
        const results = conditions.map((condition) => evaluateSingleCondition(condition, input));
    ...
    if (typeof conditions === "object") {
        const passed = evaluateSingleCondition(conditions, input);
        return {
            passed,
            skipped: !passed,
