...
export async function buildApp() {
    ...
    app.post("/queue/test", {
        schema: {
            tags: ["System"],
            summary: "Queue test",
            description: "Adds a test job to the workflow execution queue. Useful during development.",
        },
    }, async () => {
    ...
    app.get("/protected/me", {
        ...
        schema: {
            ...
            description: "Returns the workspace and API key metadata for the provided x-api-key.",
